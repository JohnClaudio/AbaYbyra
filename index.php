        ...
        <div id="login-container" class= "col-4 border my-2 bg-white">
          <div id='login' class="p-2 w-100 float-right d-lg-flex flex-column">
            ...
            <div id="buttons" class="d-flex flex-column px-2">
              ...
              <p>Cadastrar</p>
              <a id="escola-cad" class="btn mt-0 mb-2" href='escola.php' target='_self'>Escola</a>
              <a id="aluno-cad" class="btn my-2" href='aluno.php' target='_self'>Aluno</a>
              <a id="professor-cad" class="btn my-2" href='professor.php' target='_self'>Professor</a>
            </div>
          </div>
